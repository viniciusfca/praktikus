...
describe('SalesService', () => {
  ...
  describe('create', () => {
    ...
    it('should create sale with stock OUT movements when stock is sufficient', async () => {
      ...
      // Cash is an independent flow — no cash_transaction is created here.
    ...
    it('should NOT create any cash_transaction', async () => {
      ...
      const repoCallArgs = mockQueryRunner.manager.getRepository.mock.calls.map(
        (c: any[]) => c[0]?.name ?? c[0],
      );
