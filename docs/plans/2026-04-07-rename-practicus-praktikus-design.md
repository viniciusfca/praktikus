...
| `apps/backend/tsconfig.json` | path alias `@praktikus/shared` → `@praktikus/shared` |
...
| `apps/backend/test/integration/database.module.spec.ts` | DB defaults `praktikus` → `praktikus` |
